...
export function createServer() {
  ...
  app.get("/api/bot/guilds/:guildId/settings", async (request, response) => {
    ...
    response.json({ settings: mergeSettings(await getGuildSettings(guildId), guildId) });
  });
...
const defaultSettings = {
  ...
  commandTemplates: {
    ...
    announce: {
      title: "Announcement",
      message: "A new announcement has been posted for the server.",
      color: "#5865f2",
      footer: "Powered by Logic Systems",
      pingRole: "",
      channel: "",
    ...
    antiraid: {
      ...
      message: "Anti-raid protection status has been updated.",
      color: "#ff6b6b",
      footer: "Powered by Logic Systems",
      pingRole: "",
      channel: "",
    ...
    dmall: {
      ...
      message: "A server-wide direct message has been prepared.",
      color: "#5865f2",
      footer: "Powered by Logic Systems",
      pingRole: "",
      channel: "",
    ...
    embed: {
      title: "Custom Embed",
      message: "A custom embed has been posted.",
      color: "#5865f2",
      footer: "Powered by Logic Systems",
      pingRole: "",
      channel: "",
    ...
    help: {
      title: "Command Help",
      message: "Command help has been requested.",
      color: "#64d8ff",
      footer: "Powered by Logic Systems",
      pingRole: "",
      channel: "",
    ...
    membercount: {
      title: "Member Count",
      message: "The server member count has been posted.",
      color: "#76f0d2",
      footer: "Powered by Logic Systems",
      pingRole: "",
      channel: "",
    ...
    "reset-over-cooldown": {
      title: "Over Cooldown Reset",
      message: "The over command cooldown has been reset.",
      color: "#23c46e",
      footer: "Powered by Logic Systems",
      pingRole: "",
      channel: "",
    ...
    "reset-startup-cooldown": {
      title: "Startup Cooldown Reset",
      message: "The startup command cooldown has been reset.",
      color: "#23c46e",
      footer: "Powered by Logic Systems",
      pingRole: "",
      channel: "",
    ...
    say: {
      title: "Bot Message",
      message: "A bot message has been posted.",
      color: "#5865f2",
      footer: "Powered by Logic Systems",
      pingRole: "",
      channel: "",
    ...
    settings: {
      title: "Bot Settings",
      message: "Bot settings have been opened.",
      color: "#9b8cff",
      footer: "Powered by Logic Systems",
      pingRole: "",
      channel: "",
    ...
    setup: {
      title: "Server Setup",
      message: "Server setup has been started.",
      color: "#5865f2",
      footer: "Powered by Logic Systems",
      pingRole: "",
      channel: "",
    ...
    status: {
      title: "Server Status",
      message: "Server status has been posted.",
      color: "#64d8ff",
      footer: "Powered by Logic Systems",
      pingRole: "",
      channel: "",
