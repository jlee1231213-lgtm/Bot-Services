...
export const data = new SlashCommandBuilder()
  .setName("ssu")
  .setDescription("Post a server startup announcement with fill-in options.")
...
export async function execute(interaction) {
  const description = buildMessage("Server startup is now active. Join up and prepare for roleplay.", [
  ...
  await interaction.reply({ embeds: [await standardEmbed(interaction.guildId, "Server Startup", description)] });
}
